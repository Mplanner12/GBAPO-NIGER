  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          <div className="w-full px-[1rem] md:px-0 flex justify-center items-center gap-2.5 relative top-[2rem] mt-[3.5rem] left-[3.25rem] md:left-[1.5rem]">
            <img
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5 ">
              ...
              <div>
                ...
                <div className="mt-[22.5rem] md:mt-[13.5rem]">
                  <li
